...
$(function(){
   ...
   App.qUtil={
        ...
        //hint对话框显示
        errorDialogShow:function(str,isSucc){
            $(".error-dialog").fadeIn();
            $(".error-dialog p").html(str);
            var imgSrc="";
            if(isSucc)
            {
                imgSrc="style/img/icon-success.png";
            }
            else
            {
                imgSrc= "style/img/icon-fail.png"
            }
            $(".error-dialog img").attr("src",imgSrc);
            setTimeout(function(){
        ...
        //删除提示框显示
        dialogShow:function(dialog,cover){
            dialog.fadeIn();
            cover.fadeIn();
        },
        //删除提示框隐藏
        dialogHide:function(dialog,cover){
            dialog.fadeOut();
            cover.fadeOut();
        },
        //去空格
